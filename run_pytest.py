...
This script runs the comprehensive test suite using pytest with proper virtual environment activation.
"""
...
def main():
    ...
    test_commands = [
        {
            "command": "uv run python -c \"import pytest; print(f'pytest version: {pytest.__version__}')\"",
            "description": "Verify pytest installation"
        },
        {
            "command": "uv run pytest tests/test_data_preparation.py -v --no-cov",
            "description": "Data Preparation Tests"
        },
        {
            "command": "uv run pytest tests/test_model_training.py -v --no-cov",
            "description": "Model Training Tests"
        },
        {
            "command": "uv run pytest tests/test_bentoml_integration.py -v --no-cov",
